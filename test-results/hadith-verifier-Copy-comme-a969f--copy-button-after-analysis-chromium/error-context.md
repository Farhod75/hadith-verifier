...
- Name: hadith-verifier.spec.ts >> Copy comment functionality >> should show copy button after analysis
- Location: tests\hadith-verifier.spec.ts:245:7
...
Call log:
  ...
  - waiting for getByRole('button', { name: /copy comment/i })
