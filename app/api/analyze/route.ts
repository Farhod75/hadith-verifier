  ...
  try {
    ...
    const langInstruction =
      lang === 'uz'
        ...
        : lang === 'tj' ? `CRITICAL LANGUAGE INSTRUCTION: You MUST write ALL of the following fields ENTIRELY in Tajik language using Cyrillic script: claim_summary, analysis, authentic_alternative, red_flags (every item), references (description field only), and suggested_comment. Do NOT use English. Every single word in these fields must be in Tajik. Only keep JSON field names, source names, URLs, and verdict/confidence/severity values in English.`
